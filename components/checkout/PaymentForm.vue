            ...
            <form id="nonce-form" novalidate action="path/to/payment/processing/page" method="post">
                ...
                <div class="displayTable widthAll">
                    ...
                    <form-row :value-class="formValueClass">
                        <div slot="label" class="nowrap">{{ $t('Card number') }}:</div>
                        <template slot="value">
                            <status-wrapper
                    ...
                    <!-- expiration date -->
                    <form-row :value-class="formValueClass">
                        <div slot="label" class="nowrap">{{ $t('Expiration date') }}:</div>
                        <template slot="value">
                            <status-wrapper
                    ...
                    <!-- cvv -->
                    <form-row :value-class="formValueClass">
                        <div slot="label" class="nowrap">
                            {{ $t('CVV') }}:
                            <div>
                                <span class="underlineDotted fs12 cursorPointer" @click="showCvvDialog = true">
                                    {{ $t("what's this?") }}
                                </span>
                            </div>
                        </div>
                    ...
                    <!-- postal code -->
                    <form-row :value-class="formValueClass">
                        <div slot="label" class="nowrap">{{ $t('Postal code') }}:</div>
                        <template slot="value">
                            <status-wrapper
